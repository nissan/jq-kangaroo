...
export const ContractUI = ({ contractName, className = "" }: ContractUIProps) => {
  ...
  return (
    <div className="flex flex-col gap-y-6 lg:gap-y-8 py-8 lg:py-12 justify-center items-center">
      {!targetNetwork.id && <p>Select network to deploy contract</p>}
      {targetNetwork.id && (
        <>
          {!deployedContractData ? (
            <p>
              No contract found on {String(targetNetwork.name)}, please deploy it or connect to the correct network.
            </p>
          ) : (
            <div
